package com.bigdata.geoinfosys.GIS.filter;
...
//  }
    ...
    public void write(DataOutput out) throws IOException {  // -> toByteArray
        out.writeUTF(query.toText());
    }

    public void readFields(DataInput in) throws IOException { // -> parseFrom
